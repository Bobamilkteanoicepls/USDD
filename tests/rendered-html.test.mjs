...
test("ships the complete shared three-user case workflow", async () => {
  ...
  assert.match(homepage, /SWITCH DEMO ACCOUNT/);
  assert.match(homepage, /Claimant · File case/);
  assert.match(homepage, /Respondent · Appeal/);
  assert.match(homepage, /Public · Cast ballot/);
